...
public class SysRegister implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -876307738562463027L;
	...
	public String toString() {
		return "SysRegister [id=" + id + ", reservepeople=" + reservepeople + ", reservephone=" + reservephone
				+ ", guestname=" + guestname + ", idcard=" + idcard + ", roomtype=" + roomtype + ", roomnum=" + roomnum
				+ ", intime=" + intime + ", outtime=" + outtime + ", roomstate=" + roomstate + ", createtime="
				+ createtime + ", earnest=" + earnest + ", liveday=" + liveday + ", livemoney=" + livemoney
				+ ", employee=" + employee + ", reserve=" + reserve + ", guestname2=" + guestname2 + ", idcard2="
				+ idcard2 + ", guestname3=" + guestname3 + ", idcard3=" + idcard3 + ", guestname4=" + guestname4
				+ ", idcard4=" + idcard4 + "]";
	}
