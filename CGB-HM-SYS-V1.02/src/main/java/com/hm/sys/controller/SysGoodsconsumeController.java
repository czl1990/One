...
@RequestMapping("/goodsconsume/")
@Controller
public class SysGoodsconsumeController {
	...
	@RequestMapping("doGoodsconsumeListUI")
	public String doGoodsconsumeListUI() {
		return "sys/goodsconsume_list";
	}

	@RequestMapping("doGoodsconsume2ListUI")
	public String doGoodsconsume2ListUI() {
		return "sys/goodsconsume2_list";
	}
